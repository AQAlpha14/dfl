  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden w-full h-full">
      <div className="sm:flex gap-4">
        <div className="relative aspect-350/250 overflow-hidden">
          <Image
            src={imageUrl}
            alt={title}
            width={350}
        ...
        <div className="p-4">
          <div className="flex items-center justify-between gap-2 pb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="bg-primary text-white text-xs font-semibold px-4 py-2 rounded-md">
                {type}
              </span>
            </div>
            <button
              onClick={handleFavoriteClick}
              className="rounded-full hover:bg-white/20 transition"
            >
              <Heart
